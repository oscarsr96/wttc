...
export default function ListReviews(props){
  const { navigation, idDisco, setRating } = props;
    ...
    <View>
      {userLogged ? (
        <Button
          ...
          onPress={() => navigation.navigate("AddReviewDisco", {idDisco: idDisco, setReviewsReload: setReviewsReload})}
        />
      ): (
        <View>
          <Text
    ...
    <View style={styles.viewReview}>
      <View style={styles.viewImageAvatar}>
        <Avatar
          ...
          source={{uri: avatarUser ? avatarUser : "https://api.adorable.io/avatars/234/abott@adorable.png"}}
        />
      </View>
      <View style={styles.viewInfo}>
        <Text style={styles.reviewTitle}> {title} </Text>
        <Text style={styles.reviewText}>{review}</Text>
        <Rating imageSize={15} startingValue={rating} readonly style={styles.rating}/>
